  ...
  useGSAP(
    () => {
      ...
      ScrollTrigger.create({
        ...
        markers: true,
        onUpdate: (self) => {
          const progress = Math.round(self.progress * 10);
          console.log(progress);
          const img = sampleProjectRef.current.querySelector(".sp-banner-img img");

          gsap.set(img, {
            clipPath: `inset(calc(10 - ${progress}%))`,
            duration: 1,
            ease: "none"
          })
        }
            ...
            <div className="sp-copy-description">
              ...
              <div className="sp-link">
                <div className="sp-link-wrapper">
                  <AnimatedButton route="/" label="Live Demo" animate animateOnScroll delay={0.5} />
                </div>
              </div>
            </div>
          </div>
